...
; a still more general notion called accumulate
...
; the preceding terms and a null-value that specifies what base value to use when the terms run out.
...
;accumulation
;abstraction of sum and product
