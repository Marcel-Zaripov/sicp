...
; we start with an initial guess for the answer, test if the guess is good enough,
; and otherwise improve the guess and
...
; Rewrite the sqrt procedure of section 1.1.7 and
